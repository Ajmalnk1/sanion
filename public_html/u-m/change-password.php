...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(count($rs) > 0) {
        ...
        if (password_verify($old_password, $temp_password)) {
            $data = array('password' => password_hash($new_password, PASSWORD_DEFAULT));
            $r = $db->save($table_users, $data, array('email' => $email));
            if($r > 0) {
                $success = "0";
            } else {
                $error = "2";
  ...
  <body class="h-100">
          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <div class="page-header row no-gutters py-4">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                <span class="text-uppercase page-subtitle">Modify your old password with new password</span>
                  ...
                  <div class="card-body d-flex flex-column">
                    <form action="change-password.php" method="post">
                        <div class="form-group">
                            ...
                            <input type="password" placeholder="Enter your old password" class="form-control" id="old" name="old_password">
                        </div>
                        <div class="form-group">
                            <label for="new_pwd">New Password:</label>
                            <input type="password" placeholder="Enter your new password" class="form-control" id="new_pwd" name="new_password">
                        </div>
    ...
    <?php
        ...
        if(isset($error) && $error == "0") {
            echo "swal('Oops!', 'cant able to find your email id, contact administrator', 'error');";
        }
