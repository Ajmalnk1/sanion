...
if ($_SERVER["REQUEST_METHOD"] == "POST" ) {
  ...
  if($flag == "end"){
    ...
    for($i=0; $i<$li_count; $i++) {
        $total_product_count = $total_product_count + ($products_list[$i]["Quantity"]);
    ...
    $total_cost_for_sp = $total_cost_for_sp*(12)*($sub_plan);
        if($total_product_count >= 8) {
            ...
            echo "<script> alert('Minimum 8 products need to be selected to proceed.'); </script>";
        }
      ...
      <div class="fifth_container subs">
        ...
        <div class="fifth_inner">
          <div class="fifth_content">
            ...
            <form action="http://www.sanionindia.com/trial-pack.php<?php if(isset($_SESSION["ref"])) { echo "?ref=".$_SESSION["ref"]; } ?>"  method="post">
...
?>
              ...
              <div class="button">
                ...
                <p class="text-center text-danger" id="err-msg"><br>&nbsp;</p>
    ...
    outline: 0;" class="payy" type="submit" id="tp-submit-btn" value="0" name="sub0">Next</button>
      ...
      <footer>
        ...
        $(document).ready(function() {
            document.getElementById("err-msg").innerHTML = "Minimum 8 products need to be selected to proceed";
            document.getElementById("tp-submit-btn").disabled = true;
            $(document).click(function() {    
                var quantity = $('.quan').html();
                if(quantity >= 8) {
                    document.getElementById("tp-submit-btn").disabled = false;
                    document.getElementById("err-msg").innerHTML = "<br>&nbsp;";
                } else {
                    document.getElementById("tp-submit-btn").disabled = true;
                    document.getElementById("err-msg").innerHTML = "Minimum 8 products need to be selected to proceed";
                }
